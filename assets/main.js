...
// === Tooltip detalji sa Remix ikonama ===
document.addEventListener("DOMContentLoaded", () => {
  const details = document.querySelectorAll(".project__details");

  const tooltipData = [
    `
    <div><i class="ri-time-line"></i>4 dana izrade</div>
    <div><i class="ri-lightbulb-flash-fill"></i>Odlična saradnja s klijentom</div>
    <div><i class="ri-star-half-fill"></i>5/5</div>
    `,
    `
    <div><i class="ri-time-line"></i>7 dana izrade</div>
    <div><i class="ri-code-box-line"></i>Booking Sistem</div>
    <div><i class="ri-star-fill"></i>4/5</div>
    `,
    `
    <div><i class="ri-time-line"></i>14 dana izrade</div>
    <div><i class="ri-rocket-line"></i>Napredna Web Aplikacija</div>
    <div><i class="ri-star-fill"></i>5/5</div>
    `,
    `
    <div><i class="ri-time-line"></i>2 dana izrade</div>
    <div><i class="ri-brush-fill"></i>Fokus na dizajnu</div>
    <div><i class="ri-star-fill"></i>5/5</div>
    `,
    `
    <div><i class="ri-time-line"></i>6 dana izrade</div>
    <div><i class="ri-settings-3-line"></i>Backend optimizacija</div>
    <div><i class="ri-star-fill"></i>4/5</div>
    `,
    `
    <div><i class="ri-time-line"></i>8 dana izrade</div>
    <div><i class="ri-lightbulb-flash-fill"></i>Jedan od težih projekata</div>
